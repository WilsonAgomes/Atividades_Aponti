...
`Total_de_vitimas = mortos + feridos_leves + feridos_graves`: total de vítimas por acidente.
...
Foram calculados seis indicadores principais para apresentar uma visão geral dos acidentes registrados:
...
| BR | Acidentes | Mortos | Vítimas | Letalidade |
|---|---:|---:|---:|---:|
| BR-403 | 6 | 3 | 5 | 60,00% |
| BR-30 | 4 | 2 | 5 | 40,00% |
...
## Arquivo e localização dos cálculos

Abra [Atividade_Td_f.xlsx](Projeto_Unidade-4/Atividade_Td_f.xlsx). A coluna `AE` da aba de dados calcula as vítimas de cada acidente, e `KPIs!B5` apresenta sua soma. A cópia usada na unidade 5 mantém o mesmo cálculo.
